...
#define NUBIA_SYNAPTICS_TOUCH_GAME_MANUAL_MODE
...
#define CONFIG_NUBIA_DISP_PREFERENCE	1
...
struct synaptics_rmi4_data {
	...
	unsigned char prevention;
	unsigned char largepalm;
	unsigned char right_prevention;
	unsigned char left_prevention;
	unsigned char g_prevention;
	unsigned char double_prevention;
	unsigned char g_left_prevention;
	unsigned char g_right_prevention;
	...
	struct mutex rmi4_sys_node_mutex;
...
int test_sysfs_tp_raw_test_show(struct device *dev,struct device_attribute *attr, char *buf);
