...
#define RX_NUM_DEFAULT (34)
#define TX_NUM_DEFAULT (16)

#define MORGEN_CONFIG_PINCTRL
...
struct synaptics_dsx_board_data {
	...
	u32 full_raw_limit_upper[TX_NUM_DEFAULT * RX_NUM_DEFAULT];
	u32 full_raw_limit_lower[TX_NUM_DEFAULT * RX_NUM_DEFAULT];
#endif
	int max_y_for_2d;
