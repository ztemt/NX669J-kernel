991, 1001, 1052, 997, 1000, 995, 987, 989, 985, 987, 1006, 978, 982, 984, 986, 993, 993, 1003, 1003, 1015, 1022, 1034, 1048, 1059, 1068, 1074, 1080, 1087, 1093, 1099, 1104, 1110, 1118, 1107, 
979, 1000, 998, 996, 998, 990, 984, 985, 981, 982, 980, 973, 996, 978, 979, 987, 986, 996, 996, 1008, 1016, 1028, 1043, 1054, 1064, 1071, 1078, 1085, 1093, 1099, 1105, 1112, 1122, 1117, 
847, 984, 998, 990, 989, 980, 971, 969, 963, 963, 960, 951, 954, 975, 954, 961, 959, 968, 967, 980, 986, 999, 1013, 1023, 1032, 1040, 1046, 1054, 1061, 1068, 1074, 1081, 1102, 948,
};
...
#define ELEC_OPEN_INT_DUR_TWO 20
...
show_prototype(autotest)
show_prototype(rawdata)
show_prototype(delta)
show_prototype(binarydelta)
/* tddi f54 test reporting + */
...
static int synaptics_nubia_short_test(void)
{
	unsigned int ii;
	int r = 0;
	...
	for (ii = 0; ii < f54->report_size; ii++) {
		if (ii == 0 || ii == 4) {
			if (f54->report_data[ii] != 3)
				r++;
		} else {
			if (f54->report_data[ii] != 0)
				r++;
		}
	}
	return r;
...
//add by tptest
int test_sysfs_tp_raw_test_show(struct device *dev,
                struct device_attribute *attr, char *buf)
{
	int cnt = 0;
	int count = 0;
	...
	mutex_lock(&(rmi4_data->rmi4_sys_node_mutex));
	//start short test
	retval = test_sysfs_read_report_store(dev,attr,cmd,2);
	if (retval < 0) {
		mutex_unlock(&(rmi4_data->rmi4_sys_node_mutex));
		return retval;
	}

	retval = synaptics_nubia_short_test();
	if (retval) {
		mutex_unlock(&(rmi4_data->rmi4_sys_node_mutex));
	...
	cmd[0] = '3';
	cmd[1] = 0;
	retval = test_sysfs_read_report_store(dev,attr,cmd,1);
		...
		for (i = 0, k = 0; i < tx_num; i++) {
			for (j = 0; j < rx_num; j++) {
				if ((*report_data_16 < tddi_full_raw_limit_lower[k]) || (*report_data_16 > tddi_full_raw_limit_upper[k])) {
					failcnt ++;
                pr_err("*report_data_16:%-4d tx_num:%d rx_num:%d  limit_lower:%-4d limit_upper:%-4d\n",
					*report_data_16, i, j, tddi_full_raw_limit_lower[k], tddi_full_raw_limit_upper[k]);
				}
				pr_err("*report_data_16:%-4d tx_num:%d rx_num:%d  limit_lower:%-4d limit_upper:%-4d\n",
					*report_data_16, i, j, tddi_full_raw_limit_lower[k], tddi_full_raw_limit_upper[k]);
				k++;           
...
//nubia add function start



static ssize_t test_sysfs_autotest_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	unsigned int ii;
	unsigned int jj;
	...
	for (ii = 0; ii < tx_num; ii++) {
		for (jj = 0; jj < (rx_num - 1); jj++) {
			if (*report_data_16 < min && *report_data_16 > max) {
				failcnt++;
			}
			report_data_16++;
			buf += cnt;
...
static ssize_t test_sysfs_rawdata_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	unsigned int ii;
	unsigned int jj;
...
static ssize_t test_sysfs_delta_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	unsigned int ii;
	unsigned int jj;
...
static ssize_t test_sysfs_binarydelta_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
	int tx_num = f54->tx_assigned;
	int rx_num = f54->rx_assigned;
	...
	report_data_16 = (short *)f54->report_data;
	memcpy(buf, report_data_16, 2*tx_num*rx_num);

	return tx_num*rx_num*2;
}
//nubia add end
...
static int test_set_controls(void)
{
	...
	struct f54_control *control = &f54->control;
	struct synaptics_rmi4_data *rmi4_data = f54->rmi4_data;
    length   = f54->query.num_of_tx_electrodes;
