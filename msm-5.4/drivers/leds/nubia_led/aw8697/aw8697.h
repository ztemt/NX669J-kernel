...
#define NUBIA_TOUCH_KEY

#define AW8697_HAPTIC_TOUCH_ENABLE                1    // enable
#define AW8697_HAPTIC_TOUCH_DISABLE               0   // disable
#define AW8697_HAPTIC_TOUCH_MIN_GAP             10000    // 0 us
#define AW8697_HAPTIC_TOUCH_MAX_GAP             40000    // 400ms 400 000 us
...
struct aw8697 {
	...
	int touch;
	int touch_enable;
	unsigned int gap_max;
	unsigned int gap_min;
	struct timeval touch_press,audio_trig;
	unsigned long int touch_audio_gap;
    //vincent surport touch
	...
	struct aw8697_pinctrl pinctrl_info;
};
